...
const LectureItem = ({ lecture, active, index, setCurrent, role, onEdit, onDelete }) => (
  <div 
  ...
  >
    ...
    {role === "instructor" && (
      <div className="flex gap-1">
        <button className="text-blue-400" onClick={(e) => { e.stopPropagation(); onEdit(); }}>
          <Edit2 size={14} />
        </button>
        <button className="text-red-400" onClick={(e) => { e.stopPropagation(); onDelete(); }}>
          <Trash2 size={14} />
        </button>
      </div>
    )}
